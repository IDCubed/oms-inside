# Django settings for perguntus project.
import os
import sys
...
SECRET_KEY = 'rv+fo*b+l89jk5i40!k3jut*-!717_h%#9hrzclxn29cx4@yl3'
...
ROOT_URLCONF = 'perguntus.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'perguntus.wsgi.application'
